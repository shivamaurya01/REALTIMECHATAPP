  ...
  return (
    <div className="w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]">
        <div className="fixed top-[20px] left-[20px]  cursor-pointer" onClick={()=>navigate("/") }>
            <IoMdArrowRoundBack className="w-[30px] h-[50px] text-gray-600"/>
        </div>
      <div className=" bg-white border-4 rounded-full  border-[#0b96c5]  shadow-gray-400 shadow-lg relative" onClick={()=>image.current.click()}>
      ...
      <form className="w-[95%]  max-w-[500px] flex flex-col gap-[20px] items-center justify-center" onSubmit={handleProfile} >
        ...
        <input type="text" placeholder="Enter your name" className="w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[10px] bg-[white] rounded-lg shadow-gray-400 shadow-lg text-gray-700 text-[19px]" onChange={(e)=>setName(e.target.value)} value={name}/>

        <input type="text" readOnly className="w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[10px] bg-[white] rounded-lg shadow-gray-400 shadow-lg text-gray-400 text-[19px]"
        value={userData?.userName}/>
        <input type="email" readOnly className="w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[10px] bg-[white] rounded-lg shadow-gray-400 shadow-lg text-gray-400 text-[19px]" value={userData?.email}/>
